...
<head>
  ...
  <title>Orchestra 2.0 | Log in</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <hr />
    <p>
      The Proweaver Orchestra is an exclusive tool for use by Proweaver employees only. Please do not disclose any information to third parties such as clients or potential clients.
    </p>  
  </div>
  <!-- /.login-box-body -->
</div>
